...
NAMEN = [
    ("Dümmer",         "Deemer",               ["deemer", "diemer", "demer", "dimer", "deamer", "dreamer"]),
    ("Campemoor",      "Kahm-puh-mohr",        ["kampumor", "kahmpuhmohr", "campemoor", "kampamor", "kahmpamohr", "kampemor"]),
    ("Pr 31",          "P-R thirty-one",       ["pr31", "pr thirtyone", "p r 31", "prthirtyone"]),
    ("Pr 7",           "P-R seven",            ["pr7", "pr seven", "p r seven", "prseven"]),
    ("Widan el-Faras", "wih-Dahn el Fah-rass", ["widanelfaras", "wihdahnelfahrass", "huitanelfaras", "widanelfarras", "wedanelfaras"]),
    ("Nebuchadnezzar", "neb-yoo-kad-Nezzer",   ["nebuchadnezzar", "nebyookadnezzer", "nebukadnezzer", "nebuchadnezer"]),
    ("Ishtar",         "Ish-tar",              ["ishtar", "ishtaar", "ishthar"]),
    ("Susa",           "Soo-suh",              ["soosuh", "susa", "soosa", "suza"]),
    ("Sardis",         "Sar-diss",             ["sardiss", "sardis", "sardees", "sardas"]),
    ("Chaco",          "Chah-koh",             ["chahkoh", "chaco", "chako", "chalko", "chacko"]),
    ("Pueblo",         "Pweb-loh",             ["pwebloh", "pueblo", "pweblo"]),
    ("Wari",           "Wah-ree",              ["wahree", "wari", "warri", "wahri"]),
    ("Tiwanaku",       "tee-wah-Nah-koo",      ["teewahnahkoo", "tiwanaku", "tiwanahkoo", "tiwanacu"]),
    ("Westhay",        "West-hay",             ["westhay", "westhey", "westhei"]),
    ("Shapwick",       "Shap-wick",            ["shapwick", "shapwik", "shepwick", "shapwich"]),
]
...
ZAHLEN = [
    ("3807 BC", "thirty-eight-oh-seven B C",   ["3807", "thirtyeightohseven", "38 oh 7", "thirtyeight07"], ["threethousand"]),
    ("3806",    "thirty-eight-oh-six",          ["3806", "thirtyeightohsix"],                              ["threethousand"]),
    ("3838 BC", "thirty-eight-thirty-eight B C", ["3838", "thirtyeightthirtyeight"],                       ["threethousand"]),
    ("569 BC",  "five-sixty-nine B C",          ["569", "fivesixtynine"],                                  ["fivehundred"]),
    ("312 BC",  "three-twelve B C",             ["312", "threetwelve"],                                    ["threehundred"]),
    ("50.5 km", "fifty point five kilometres",  ["505", "fiftypointfive", "50.5"],                          []),
    ("25. Jh.", "twenty-fifth century B C",     ["25th", "twentyfifth"],                                   []),
]
