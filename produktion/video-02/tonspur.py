#!/usr/bin/env python3
"""Vertont sprechtext.txt mit ElevenLabs nach den Werten aus Video 1.

Wortgleich uebernommen aus produktion/video-01/tonspur.py. Uebernommen,
nicht neu gebaut: Stimme, Modell, Seed und Tempo sind bei Video 1
gemessen worden (stimmproben/elevenlabs/README.md), und eine zweite
Stimme fuer denselben Kanal waere ein anderer Kanal. Alle Pfade sind
relativ zum Modulverzeichnis, deshalb liest die Kopie von sich aus den
Sprechtext von Video 2.
