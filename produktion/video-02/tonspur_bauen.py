#!/usr/bin/env python3
"""Setzt die 24 Absatzdateien zu einer Tonspur zusammen.

Aus produktion/video-01/tonspur_bauen.py uebernommen. Geaendert ist nur
die erwartete Absatzzahl: Video 2 hat 24 Absaetze, Video 1 hatte 17.
PAUSE_S bleibt bei 0,42 s — der Wert stammt aus Video 1 und ist dort am
Hoereindruck der Fugen festgelegt worden.
...
def main() -> None:
    ...
    if len(teile) != 24:
        raise SystemExit(f"{len(teile)} Absaetze gefunden, erwartet 24")
