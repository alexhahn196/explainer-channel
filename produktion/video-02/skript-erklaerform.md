# Video 2 — Skript in Erklärform (abgelöst am 16.08.2026)

> **Diese Fassung wurde durch die Erzählfassung ersetzt** — Entscheidung nach
> der Tonprobe vom 16.08.2026 (siehe `tonprobe-*.txt` und die Messtabellen
> dort). Sie bleibt liegen, weil ihre Quellen-Zuordnung und die
> Unsicherheits-Liste weiterhin die Referenz sind: die Erzählfassung nutzt
> dieselben Fakten, dieselben Zahlen und dieselben Quellen-IDs.
> Nicht vertonen, nicht weiterbearbeiten.
...
| [L8] | Hertzsprung 1913, Astron. Nachr. **196** (üblich zitiert S. 201; **kein Crossref-DOI auffindbar**, Methode über zwei selbst gelesene Sekundärquellen belegt, siehe Nachtrag im Recherchebericht) | Nachtrag nach Prüfrunde 1 |
