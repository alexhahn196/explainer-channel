...
> unten löst sie auf. `[A]` heißt: eigene Rechnung, offengelegt im
> Recherchebericht unter „Eigene Rechnungen".
>
> Bindende Regeln aus dem Recherchebericht, hier umgesetzt:
> **kein Prioritäts-Superlativ** (wer 1838 „der Erste" war, beantwortet die
> Literatur dreifach verschieden — das Skript nennt alle drei Ansprüche);
> alles dort als [umstritten] Markierte ist **hörbar als offen** formuliert;
> die fünf in der Gegenprüfung **verworfenen Erzählungen kommen nicht vor**:
...
Look up tonight and pick a star. Any star you like. Now ask yourself: how far away is that thing? If you draw a blank, you're in good company. In one survey of more than three thousand people, one in four said the stars are closer to us than the Sun [L1]. Asked to put a number on the nearest star, five out of six students wouldn't even guess [L1]. Of those who did, only one in five landed in the right range — about three people in a hundred [L1][A]. So how do astronomers know? Here's the answer, right away: with a triangle. No probe flies out there. No radar comes back. You measure an angle, twice, half a year apart — and geometry does the rest. And you already own the trick.

Hold up your thumb at arm's length. Shut your left eye. Now swap eyes. Your thumb jumps against the wall — because each of your eyes looks from its own spot. Two viewpoints, one shift: that's how you see depth. To do the same with a star, you need two viewpoints as far apart as you can get them. And the farthest pair you will ever own is this: the Earth in January, and the Earth in July. Two points of your planet's orbit, three hundred million kilometres apart [A]. Photograph a near star from both. Against the sea of far stars behind it, it jumps — just like your thumb did. Half of that jump, as an angle, is called the parallax. One clean rule ties it to distance: the smaller the jump, the farther the star [W1].

Simple? You'd think so. Here's the catch: from the idea to the first measured jump took two hundred and ninety-five years [A].

Copernicus set the Earth moving in 1543, and the objection came at once: if we ride a moving platform, the stars should sway — and nobody saw any sway [W6]. The sharpest eyes of that century belonged to Tycho Brahe, a Danish noble who charted the sky, with no telescope, more finely than anyone alive. He looked. Nothing. Then he did the maths on that nothing: to hide from his instruments, the stars would have to sit seven hundred times farther out than Saturn [W5]. Worse: to his eye, every bright star showed a tiny round disk. A disk that wide, pushed that far out, means a star of monstrous size — dwarfing the Sun. Too absurd to accept, he judged, and kept the Earth still [W5]. His logic was sound. His premise was not. The disks are not real. Air and eye wrap every point of light in blur, and what Tycho measured was the blur. The largest true star disk in our sky is about a thousand times smaller than what he saw [W5][A]. It took until around 1700 to accept the disks as an illusion — an "optick fallacy," as one astronomer put it [W6]. Tycho wasn't sloppy. He measured what a human eye can see — it just wasn't the star.

So the hunt ran on — into the 1830s, when it became a race. Three men, three cities, three stars.

In Königsberg, Friedrich Bessel had a new tool: a telescope whose main lens was cut clean in half, one half sliding on a fine screw [W7]. Slide it until two star images meet, read the screw, and you've read an angle no eye could split. He aimed it at a dim star called 61 Cygni — picked because it crawls across the sky unusually fast [W2]. An Italian, Giuseppe Piazzi, had spotted that hurry in 1792, and a fast star is usually a near one [W2]. Through 1837 and 1838 Bessel measured; then he published: a jump of about a third of an arcsecond [W2][L2]. An arcsecond — take one degree, cut it into three thousand six hundred slices, keep one. Bessel's angle is a two-euro coin seen from seventeen kilometres [A]. From it he got a distance of about ten light-years — a light-year being the stretch light crosses in one year, nine and a half trillion kilometres [W2]. Today's value for that star: eleven point four [W2]. With a sawn lens and a screw, he came within a tenth of the truth [A].

But he wasn't first to measure. Five years before, at the Cape of Good Hope, Thomas Henderson had caught the jump of a bright southern star, Alpha Centauri — and put the result in a drawer. Earlier claims of a parallax had been shot down; the story handed down says he didn't trust his own numbers [W3]. He published in 1839 — second, for want of nerve [W3]. And in Dorpat, Wilhelm Struve had measured Vega and landed close to today's value — 0.125 arcseconds, against the modern 0.129 [W4]. Then Bessel doubted his data, and Struve revised his good number to nearly double. Away from the truth. Colleagues stopped trusting his work [W4]. So who was first? Pick your rule. First to measure: Henderson. First to make the full case in print: Bessel. First to print any number at all: arguably Struve. The reference books give all three answers — side by side [W1][W4].

You'd think it gets easy after that. It doesn't. The angles are brutal. By 1900 — sixty years on — astronomers had collected about sixty parallaxes in total [W1]. Sixty known distances, in a galaxy of billions [W10]. The real jump came when measuring left the ground. A satellite called Hipparcos pinned down 118,000 stars in the 1990s — though only about one in six of them with an error under ten percent [W8][A]. Then Gaia, a European craft that scanned the sky from 2013 to 2025, measuring more than a billion stars [W9]. At its sharpest, its angle is that same two-euro coin — now seen from 759,000 kilometres, twice as far as the Moon [A]. And still: the triangle runs out inside our own galaxy. The Milky Way spans some 87,000 light-years, give or take a few thousand [W10] — and for most stars, Gaia's sharp reach covers a slice of that [W9][A]. Past it, the jump drowns in noise. No bigger telescope can fix that: the base of the triangle is the Earth's orbit, and that's as wide as it gets. The geometry is used up.
...
Harvard, 1908 to 1912 [W11]. Henrietta Leavitt worked in a room of women hired to read glass photographs of the sky — plates taken by the men who ran the telescopes, and brought in for the women to measure [W11]. Her plates showed the Small Magellanic Cloud, a small companion galaxy of ours. On them she found stars that pulse: they brighten, fade, and brighten again, on a steady beat of days or weeks. We now call them Cepheids [W11][W12]. Across twenty-five of them, she found the pattern: the slower the beat, the brighter the star [W11]. On her chart, the points fell along two clean straight lines [W11]. And she wrote down, herself, what it meant: these stars all sit at roughly the same distance from us — they share the Cloud — so the beat must track how much light a star truly puts out [W11]. Hold on to that — it unlocks the deep universe. Read a Cepheid's rhythm, and you know its true brightness. Compare that with how faint it looks, and the dimming hands you the distance. Astronomers call that a standard candle: a lamp whose true output you know. Hers could be read across millions of light-years.

One catch — and she named it too. Her chart had no scale. No one knew the distance to the Cloud itself, so her law gave only ratios: this star is four times farther than that one. Four times what? She wrote that she hoped parallaxes would be measured for a few stars of this kind [W11]. A year on, Ejnar Hertzsprung did roughly that with nearby Cepheids — and pinned her scale to the triangle [W11]. Mark that shape — everything since is built the same way: rung two stands on rung one. Cepheids are calibrated by parallax. The rungs above — exploding stars, whole galaxies — are calibrated by Cepheids. Every rung inherits the reach of the one below. And every rung inherits its errors [W16].
...
And today, the ladder is in its third fight — this one still open [W18]. Two numbers for how fast the universe grows. From the oldest light there is, the Planck satellite reads 67.4, with an error of half a point [L5]. From the ladder — parallax, to Cepheids, to exploding stars that all flare to nearly the same true brightness [W17] — a team called SH0ES reads 73.0, plus or minus one. A five-sigma difference, in their own words: far too large to be chance [L4]. You'll hear that sold as the young universe against the old one. But here's what that framing skips. A second team climbed the same ladder with a different second rung — red giant stars instead of Cepheids, on the new James Webb telescope — and read 67.8 to 70.4, depending on the sample and the method [L6]. Comfortable with Planck. Their own verdict: no new physics needed [L6]. Same universe. Same ladder. Different rung — different answer. And the strangest part: both teams agree on the distances to the very same galaxies, to about one percent [L6]. The stars are not the quarrel. The quarrel is over which exploding stars to hang the scale on. The ladder holds; the argument is about the nail. Nobody yet knows which side is right [W18].

So — how do we know how far away the stars are? For the near ones: a triangle. Your thumb trick, stretched across the Earth's orbit, sharpened until a coin past the Moon is an easy target. For the far ones: a ladder of light. A rhythm read off glass plates for thirty cents an hour, nailed to the triangle, broken twice, patched twice, and argued over right now. One in four of us thinks the stars hang closer than the Sun. The nearest one sits so deep that its light spends four years on the road to you [W1]. But that number is no guess, and never was. Someone caught its jump. Someone read its beat. And beside every distance, they wrote a second number: how far off it might be. That second number is the honest answer. We don't just know how far the stars are. We know how well we know it — and exactly where we don't.

---

## Quellen

| ID | Quelle | Stelle im Bericht |
|---|---|---|
| [W1] | [Stellar parallax](https://en.wikipedia.org/wiki/Stellar_parallax) (en.wikipedia, selbst gegengelesen) | Kandidat 1 + 3 |
| [W2] | [61 Cygni](https://en.wikipedia.org/wiki/61_Cygni) (en.wikipedia, selbst gegengelesen) | Kandidat 1, Szenentabelle |
| [W3] | [Thomas Henderson (astronomer)](https://en.wikipedia.org/wiki/Thomas_Henderson_(astronomer)) (en.wikipedia) | Kandidat 1 |
| [W4] | [Vega](https://en.wikipedia.org/wiki/Vega) (en.wikipedia, selbst gegengelesen) | Kandidat 1 |
| [W5] | [Tycho Brahe](https://en.wikipedia.org/wiki/Tycho_Brahe) und [Tychonic system](https://en.wikipedia.org/wiki/Tychonic_system) (en.wikipedia, selbst gegengelesen) | Kandidat 2 |
| [W6] | [Copernican heliocentrism](https://en.wikipedia.org/wiki/Copernican_heliocentrism) (en.wikipedia, selbst gegengelesen) | Kandidat 2 |
| [W7] | [Heliometer](https://en.wikipedia.org/wiki/Heliometer) (en.wikipedia) | Szenentabelle K1 |
| [W8] | [Hipparcos](https://en.wikipedia.org/wiki/Hipparcos) (en.wikipedia, selbst gegengelesen) | Kandidat 3 |
| [W9] | [Gaia (spacecraft)](https://en.wikipedia.org/wiki/Gaia_(spacecraft)) (en.wikipedia, selbst gegengelesen) | Kandidat 3 |
| [W10] | [Milky Way](https://en.wikipedia.org/wiki/Milky_Way) (en.wikipedia, selbst gegengelesen) | Kandidat 3 |
| [W11] | [Henrietta Swan Leavitt](https://en.wikipedia.org/wiki/Henrietta_Swan_Leavitt), [Leavitt's law](https://en.wikipedia.org/wiki/Leavitt%27s_law), [Harvard Plate Stacks](https://platestacks.cfa.harvard.edu/terminology-women-astronomical-computers) (selbst gegengelesen) | Kandidat 4 |
| [W12] | [Cepheid variable](https://en.wikipedia.org/wiki/Cepheid_variable) (en.wikipedia, selbst gegengelesen) | Kandidat 4 + 5 |
| [W13] | [Hubble's law](https://en.wikipedia.org/wiki/Hubble%27s_law) und [Cosmic age problem](https://en.wikipedia.org/wiki/Cosmic_age_problem) (en.wikipedia, selbst gegengelesen) | Kandidat 5, Bruch 1 |
| [W14] | [Walter Baade](https://en.wikipedia.org/wiki/Walter_Baade) (en.wikipedia) | Kandidat 5, Bruch 1 |
| [W15] | [Pleiades](https://en.wikipedia.org/wiki/Pleiades) und [Hipparcos](https://en.wikipedia.org/wiki/Hipparcos) (en.wikipedia, selbst gegengelesen) | Kandidat 5, Bruch 2 |
| [W16] | [Cosmic distance ladder](https://en.wikipedia.org/wiki/Cosmic_distance_ladder) (en.wikipedia, selbst gegengelesen) | Kandidat 3 + 4 |
| [W17] | [Type Ia supernova](https://en.wikipedia.org/wiki/Type_Ia_supernova) (en.wikipedia) | „Weitere geprüfte Kandidaten" |
| [W18] | [Hubble tension](https://en.wikipedia.org/wiki/Hubble_tension) (en.wikipedia, selbst gegengelesen) — *„The cause of the Hubble tension is unknown"* | Kandidat 5, Bruch 3 |
| [L1] | Belgien-Umfrage 2012, n > 3.000 — [arXiv:1308.3963](https://arxiv.org/abs/1308.3963), **PDF-Volltext lokal ausgelesen** | Schritt 1 |
| [L2] | Bessel 1839, *Bestimmung der Entfernung des 61sten Sterns des Schwans*, Astron. Nachr. **16**, 65–96 — [10.1002/asna.18390160502](https://doi.org/10.1002/asna.18390160502) | Kandidat 1 |
| [L3] | Melis u. a. 2014, Science **345**, 1029–1032 — [10.1126/science.1256101](https://doi.org/10.1126/science.1256101) | Kandidat 5, Bruch 2 |
| [L4] | Riess u. a. 2022 (SH0ES), ApJL **934**, L7 — [10.3847/2041-8213/ac5c5b](https://doi.org/10.3847/2041-8213/ac5c5b) — wörtlich *„a 5-sigma difference"* | Kandidat 5, Bruch 3 |
| [L5] | Planck 2018 VI, A&A **641**, A6 (erschienen 2020) — [10.1051/0004-6361/201833910](https://doi.org/10.1051/0004-6361/201833910) | Kandidat 5, Bruch 3 |
| [L6] | Freedman u. a. 2025 (CCHP), ApJ **985**, 203 — [10.3847/1538-4357/adce78](https://doi.org/10.3847/1538-4357/adce78) | Kandidat 5, Bruch 3 |
| [L7] | Hubble 1929, PNAS **15**, 168–173 — [10.1073/pnas.15.3.168](https://doi.org/10.1073/pnas.15.3.168) | Kandidat 5, Bruch 1 |
| [A] | Eigene Rechnung — jede einzelne steht im Recherchebericht unter „Eigene Rechnungen" mit Rechenweg | Rohdaten |
...
| Wörter unter 7 Zeichen | ≥ 82 % | **86,3 %** | ✓ |
