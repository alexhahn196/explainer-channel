...
steht die richtige Schreibung. "SEF-ee-ids" wird also wieder zu "Cepheids".

Aus produktion/video-01/untertitel.py uebernommen. Geaendert ist nur der
Name der Ersetzungstabellen: Video 2 hat NAMEN und ZAHLEN, Video 1 hatte
GEMESSEN, UNGEPRUEFT und ZAHLEN.
"""
...
def rueck_umschreibung(s: str) -> str:
    ...
    import sprechtext
    for alt, neu in sprechtext.NAMEN + sprechtext.ZAHLEN:
        s = s.replace(neu, alt)
    return s
