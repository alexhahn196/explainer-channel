...
| **Themen** | ✅ **42 Fragen terminiert bis 08/2027** — Anlass-Kalender mit 22 belegten Ereignissen, Titelprüfung gegen 136 Konkurrenztitel, Belegbarkeit über Crossref und Wikipedia: [`recherche/themen-erklaerkanal.md`](recherche/themen-erklaerkanal.md). Nachgeprüft gegen die Vergleichskanäle, Stand 08/2026: [`recherche/vergleichskanaele-90-tage.md`](recherche/vergleichskanaele-90-tage.md) — 2 Fragen (F38, F18) stehen inzwischen fast wörtlich bei einem anderen Kanal, beide dort durchgefallen; kein Titelmerkmal der 28 Treffer hält der Prüfung stand |
